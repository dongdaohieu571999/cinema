...
var lightbox = function(o) {
    var s = void 0
      ...
      , r = function(e) {
        if ("A" === o.tagName && (e = e.getAttribute("href")),
        e.match(/\.(jpeg|jpg|gif|png)/)) {
            var t = m.createElement("img");
            return t.className = "lightbox-image",
            t.src = e,
        ...
        if (e.match(/(youtube|vimeo)/)) {
            var a = [];
            return e.match("youtube") && (a.id = e.split(/v\/|v=|youtu\.be\//)[1].split(/[?&]/)[0],
            a.url = "youtube.com/embed/",
            a.options = "?autoplay=1&rel=0"),
            e.match("vimeo") && (a.id = e.split(/video\/|https:\/\/vimeo\.com\//)[1].split(/[?&]/)[0],
      ...
      , E = function(e) {
        var t = e.target
          , a = e.keyCode
          , i = e.type;
        (("click" == i && -1 !== [d, s].indexOf(t) || "keyup" == i && 27 == a) && d.parentElement === o.parentElement && (N("remove"),
        d.style.animation = v,
        ...
        c) && (("click" == i && t == c.next || "keyup" == i && 39 == a) && x("next"),
        ("click" == i && t == c.previous || "keyup" == i && 37 == a) && x("previous"));
        if ("keydown" == i && 9 == a) {
            ...
            var n = (l = d.querySelectorAll(l.toString()))[0]
              , r = l[l.length - 1];
            e.shiftKey ? m.activeElement == n && (r.focus(),
            e.preventDefault()) : (m.activeElement == r && (n.focus(),
            e.preventDefault()),
    ...
    !function() {
        if ((s = m.createElement("button")).setAttribute("aria-label", "Close"),
        ...
        "A" === o.tagName && "gallery" === o.getAttribute("data-lightbox"))
            ...
            c = {
                ...
                c.hasOwnProperty(e) && (c[e] = s.cloneNode(!1),
